...
namespace APICallScheduler.Controllers
{
    public class SchedulerController : Controller
    {
        ...
        public string GetTokenForAuth()
        {
            ...
            JavaScriptSerializer js = new JavaScriptSerializer();
            AUthorizationResponseModel aUthorizationModelResponse = new AUthorizationResponseModel();
            aUthorizationModelResponse = new JavaScriptSerializer().Deserialize<AUthorizationResponseModel>(json);
